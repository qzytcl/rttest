...
//    NSArray *arr = @[@1, @1, @1, @1, @1, @5, @1, @3, @2];
////    BOOL result = [Utilssss checkAtion2:arr m:2 w:2];
//
//    BOOL result = [Utilssss checkAtion:arr m:2 w:2];
//    if (result) {
//        NSLog(@"Error");
//    }else{
//        NSLog(@"OK");
...
//    NSArray *textArr = @[@{@"key1":@"123\n456",@"key2":@"6789;0"},@{@"keyA":@"valueA"}];
//    NSString *resultString = [Utilssss getTextWithArray:textArr];
//    NSLog(@"%@", resultString);
//    NSArray *resultArr = [Utilssss getArrayWithText:resultString];
//    NSLog(@"%@", resultArr);
